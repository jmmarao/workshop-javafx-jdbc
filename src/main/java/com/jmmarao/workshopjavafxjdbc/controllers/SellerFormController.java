...
public class SellerFormController implements Initializable {
    ...
    private Seller getFormData() {
        ...
        sellerFormData.setEmail(txtEmail.getText());
        ...
        if (datePickerBirthDate.getValue() == null) {
            ...
            sellerFormData.setBirthDate(Date.from(instant));
        }
        ...
        sellerFormData.setBaseSalary(ParseUtils.tryParseStringToDouble(txtBaseSalary.getText()));

        sellerFormData.setDepartment(comboBoxDepartment.getValue());
